...
def load_data(messages_filepath, categories_filepath):
    """
    Load data function helps loading data into a dataframe
...
def clean_data(df):
    """
    Clean data function helps clean data into a workable dataframe
    INPUT: dataframe
...
def save_data(df, database_filepath):
    """
    Save data function saves clean data into a sql database
    INPUT: dataframe
    OUTPUT: 
    """
